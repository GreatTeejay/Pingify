...
T_PORT=9443; T_PUBLIC_IP="203.0.113.9"
...
check "no secret is written"  "$(grep -ci 'token\|psk' "$iran")"        "0"
...
T_PORT=9443; T_PEER_IP="203.0.113.9"; T_PUBLIC_IP="198.51.100.4"
...
# ---------------------------------------------------------------------------
cfg_reset
T_NAME="ic"; T_ROLE="server"; T_TRANSPORT="icmp"
...
# ---------------------------------------------------------------------------
cfg_reset
T_NAME="broken2"; T_ROLE="server"; T_TRANSPORT="tcp"
